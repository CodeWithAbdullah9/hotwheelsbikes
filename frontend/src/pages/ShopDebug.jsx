...
export default function ShopDebug() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        console.log('🔄 Starting fetch to:', 'http://localhost:5002/api/products/public');
                ...
                <div style={{ 
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      const backendImage = 'http://localhost:5002/uploads/products/' + imageName;
                      ...
                      e.target.onerror = () => {
                        ...
                        const placeholderUrl = 'https://via.placeholder.com/400x400/0f2214/4ade80?text=' + encodeURIComponent(product.name);
